...
const meta: Meta<typeof DuButton> = {
  title: 'Components/Actions/du-button',
  component: DuButton,
  tags: ['autodocs'],
  argTypes: {
...
<div class="flex gap-2 items-center">
    <du-button size="xs">Xsmall</du-button>
    <du-button size="sm">Small</du-button>
    <du-button>Medium</du-button>
    <du-button size="lg">Large</du-button>
    <du-button size="xl">Xlarge</du-button>
</div>`
...
<div class="flex gap-2 items-center">
    <du-button>du-button</du-button>
    <du-button as="a" href="https://example.com">Link</du-button>
    <du-button as="input" value="Input" />
    <du-button type="submit">Submit</du-button>
    <du-button as="input" inputType="submit" value="Submit" />
    <du-button as="input" inputType="checkbox" aria-label="Checkbox" />
</div>`
...
<div class="inline-flex flex-col gap-4 justify-center">
  <!-- Email -->
  <du-button class="bg-white text-black border-[#e5e5e5]">
  ...
  <!-- GitHub -->
  <du-button class="bg-black text-white border-black">
  ...
  <!-- Facebook -->
  <du-button class="bg-[#1A77F2] text-white border-[#005fd8]">
  ...
  <!-- Kakao -->
  <du-button class="bg-[#FEE502] text-[#181600] border-[#f1d800]">
  ...
  <!-- Amazon -->
  <du-button class="bg-[#FF9900] text-black border-[#e17d00]">
  ...
  <!-- Microsoft -->
  <du-button class="bg-[#2F2F2F] text-white border-black">
  ...
  <!-- Line -->
  <du-button class="bg-[#03C755] text-white border-[#00b544]">
  ...
  <!-- Slack -->
  <du-button class="bg-[#622069] text-white border-[#591660]">
  ...
  <!-- LinkedIn -->
  <du-button class="bg-[#0967C2] text-white border-[#0059b3]">
  ...
  <!-- VK -->
  <du-button class="bg-[#47698F] text-white border-[#35567b]">
