...
<div class="inline-flex flex-col gap-4 justify-center">
  <!-- Email -->
  <ButtonLink class="bg-white text-black border-[#e5e5e5]">
  ...
  <!-- GitHub -->
  <ButtonLink class="bg-black text-white border-black">
  ...
  <!-- Facebook -->
  <ButtonLink class="bg-[#1A77F2] text-white border-[#005fd8]">
  ...
  <!-- Kakao -->
  <ButtonLink class="bg-[#FEE502] text-[#181600] border-[#f1d800]">
  ...
  <!-- Amazon -->
  <ButtonLink class="bg-[#FF9900] text-black border-[#e17d00]">
  ...
  <!-- Microsoft -->
  <ButtonLink class="bg-[#2F2F2F] text-white border-black">
  ...
  <!-- Line -->
  <ButtonLink class="bg-[#03C755] text-white border-[#00b544]">
  ...
  <!-- Slack -->
  <ButtonLink class="bg-[#622069] text-white border-[#591660]">
  ...
  <!-- LinkedIn -->
  <ButtonLink class="bg-[#0967C2] text-white border-[#0059b3]">
  ...
  <!-- VK -->
  <ButtonLink class="bg-[#47698F] text-white border-[#35567b]">
  ...
  <!-- WeChat -->
  <ButtonLink class="bg-[#5EBB2B] text-white border-[#4eaa0c]">
