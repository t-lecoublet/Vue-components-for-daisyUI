...
<div class="flex gap-2 items-center">
    <Button variant="neutral" v-bind="args">Neutral</Button>
    <Button variant="primary" v-bind="args">Primary</Button>
    <Button variant="secondary" v-bind="args">Secondary</Button>
    <Button variant="accent" v-bind="args">Accent</Button>
    <Button variant="info" v-bind="args">Info</Button>
    <Button variant="success" v-bind="args">Success</Button>
    <Button variant="warning" v-bind="args">Warning</Button>
    <Button variant="error" v-bind="args">Error</Button>
</div>
`;
...
<div class="flex gap-2 items-center">
    <Button :ghost="true" v-bind="args">Ghost</Button>
    <Button :link="true" v-bind="args">Link</Button>
</div>`;
...
const DisabledButtonTplStr = `
  <Button :disabled="true" v-bind="args">Disabled using attribute</Button>
`;

const CircleButtonAndSquareButtonTplStr = `
<div class="flex gap-2 items-center">
    <Button :circle="true" v-bind="args">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="size-[1.2em]"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" /></svg>
    </Button>
    <Button :square="true" v-bind="args">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="size-[1.2em]"><path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" /></svg>
    </Button>
</div>
`;
...
const ButtonBlockTplStr = `
  <Button block v-bind="args">Block</Button>
`;
